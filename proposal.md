...
Los clientes (usuarios) podrán ingresar al sistema para registrar sus pedidos, mientras que el administrador general (administrador) tendrá permitido visualizar listados de pedidos tanto generales como filtrados según atributos determinados, además de poder modificar los tipos de viandas.
